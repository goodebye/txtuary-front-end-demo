...
var author$project$Palette$spacing = {large: 64, normal: 32, small: 16, thinBorder: 1, xLarge: 128, xSmall: 8, xxSmall: 4};
...
var author$project$Main$viewBlurb = A2(
	...
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$spacing(author$project$Palette$spacing.xSmall)
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_Nil,
			mdgriffith$elm_ui$Element$text('best book ever baby lol olololol')),
			A2(
			...
			_List_fromArray(
				[
					...
					{description: 'watever', src: 'images/usericon.png'}),
...
var author$project$Palette$color = {
	background: A4(mdgriffith$elm_ui$Element$rgba, 1, 1, 1, 1),
	black: A4(mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 1),
	body: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 1),
	gray: A4(mdgriffith$elm_ui$Element$rgba255, 80, 80, 80, 1),
	primary: A4(mdgriffith$elm_ui$Element$rgba255, 245, 62, 172, 1),
	secondary: A4(mdgriffith$elm_ui$Element$rgba255, 66, 226, 252, 1),
	tertiary: A4(mdgriffith$elm_ui$Element$rgba255, 253, 222, 66, 1),
	white: A4(mdgriffith$elm_ui$Element$rgba, 1, 1, 1, 1)
};
...
var author$project$Main$viewBlurbs = A2(
	mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Background$color(author$project$Palette$color.white),
			mdgriffith$elm_ui$Element$Font$color(author$project$Palette$color.black),
			mdgriffith$elm_ui$Element$padding(author$project$Palette$spacing.small),
			mdgriffith$elm_ui$Element$spacing(author$project$Palette$spacing.small),
			mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
		]),
	_List_fromArray(
		[author$project$Main$viewBlurb, author$project$Main$viewBlurb]));
...
var author$project$Palette$retroShadow = function (shadowColor) {
	return mdgriffith$elm_ui$Element$Border$shadow(
		{
			blur: 0,
			color: shadowColor,
			offset: _Utils_Tuple2(author$project$Palette$spacing.xxSmall, author$project$Palette$spacing.xxSmall),
			size: author$project$Palette$spacing.thinBorder
		});
};
...
var author$project$Main$viewBookCover = function (url) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							label: mdgriffith$elm_ui$Element$text('Liveblog i\'m testing much longer titles just to see'),
							url: 'whatever'
						})
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						{
							label: mdgriffith$elm_ui$Element$text('Megan Boyle'),
							url: 'null'
						})
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$text('$15.99+'))
					])),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$Font$italic,
							author$project$Palette$retroShadow(author$project$Palette$color.black),
							mdgriffith$elm_ui$Element$Background$color(author$project$Palette$color.primary),
							mdgriffith$elm_ui$Element$Font$color(author$project$Palette$color.white),
							mdgriffith$elm_ui$Element$padding(5)
						]),
					{
						label: mdgriffith$elm_ui$Element$text('Buy'),
						onPress: elm$core$Maybe$Just(author$project$Main$NoOp)
					}))
			]));
};
...
var author$project$Palette$fontRegular = mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$external(
			{name: 'Nanum Gothic', url: 'https://fonts.googleapis.com/css?family=Nanum+Gothic'})
		]));
var author$project$Main$viewBookDescription = A2(
	mdgriffith$elm_ui$Element$column,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Font$size(16),
					author$project$Palette$fontRegular,
					mdgriffith$elm_ui$Element$padding(author$project$Palette$spacing.small)
				]),
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('In 2013, Megan Boyle was unhappy with the life she was living and wanted to document it on the internet for an audience. Her hope was that if she documented each thought and action on the internet, then she would begin to behave in a manner more appropriate to the life she wanted to live. She needed a judge and a jury to see her crimes and non-crimes, her actions and thoughts, and her life. The results are an illuminating text of great length with poetic insight on every page. It is a reading experience that leaves a little bit of Megan Boyle inside of you long after you have finished reading it.')
				]))
		]));
var author$project$Main$viewTag = function (tagText) {
	return A2(
		mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$Font$italic,
				author$project$Palette$retroShadow(author$project$Palette$color.black),
				mdgriffith$elm_ui$Element$Background$color(author$project$Palette$color.tertiary),
				mdgriffith$elm_ui$Element$Font$color(author$project$Palette$color.black),
				mdgriffith$elm_ui$Element$padding(5)
			]),
		{
			label: mdgriffith$elm_ui$Element$text('#' + tagText),
			onPress: elm$core$Maybe$Just(author$project$Main$NoOp)
		});
};
var author$project$Main$viewTags = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$alignBottom,
	...
	_List_fromArray(
		[
			author$project$Main$viewTag('alt-lit'),
			author$project$Main$viewTag('autobiographical'),
			author$project$Main$viewTag('greatstuff')
		]));
...
var author$project$Main$viewFeedItemContent = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					author$project$Main$viewBookCover('images/liveblog.jpg')
				])),
			A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[author$project$Main$viewBookDescription])),
							author$project$Main$viewBlurbs
						])),
					author$project$Main$viewTags
				]))
		]));
var author$project$Main$viewFeedItemDescription = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$Background$color(author$project$Palette$color.white),
			mdgriffith$elm_ui$Element$alignLeft,
			mdgriffith$elm_ui$Element$padding(author$project$Palette$spacing.xSmall),
			author$project$Palette$retroShadow(author$project$Palette$color.black),
			mdgriffith$elm_ui$Element$Border$solid,
			mdgriffith$elm_ui$Element$Border$width(1),
			mdgriffith$elm_ui$Element$centerX,
		...
		[
			...
			_List_fromArray(
				[
					...
					{
						label: mdgriffith$elm_ui$Element$text('Liveblog'),
						url: 'null'
					}),
					mdgriffith$elm_ui$Element$text(' 🎉')
				]))
...
var author$project$Main$viewIcon = A2(
	...
	_List_fromArray(
		[
			...
			_Utils_update(
				author$project$Main$edges,
				{left: author$project$Palette$spacing.small}))
		]),
	A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
		...
		A2(
			...
			{description: 'user icon', src: 'images/usericon.png'})));
var author$project$Main$viewFeedItem = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$spacing(author$project$Palette$spacing.small),
			...
			_Utils_update(
				author$project$Main$edges,
				{bottom: author$project$Palette$spacing.normal, right: author$project$Palette$spacing.normal}))
		]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[author$project$Main$viewFeedItemDescription, author$project$Main$viewFeedItemContent]))
		]));
var author$project$Main$viewLoginButton = A2(
	mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$size(18),
			mdgriffith$elm_ui$Element$Font$italic,
			author$project$Palette$retroShadow(author$project$Palette$color.black),
			mdgriffith$elm_ui$Element$Background$color(author$project$Palette$color.secondary),
			mdgriffith$elm_ui$Element$Font$color(author$project$Palette$color.black),
			mdgriffith$elm_ui$Element$padding(5)
		]),
	{
...
var author$project$Main$viewNavbarLogo = A2(
	mdgriffith$elm_ui$Element$image,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$centerY,
			mdgriffith$elm_ui$Element$alignLeft,
			mdgriffith$elm_ui$Element$height(
			mdgriffith$elm_ui$Element$px(author$project$Palette$spacing.normal)),
			mdgriffith$elm_ui$Element$width(
			mdgriffith$elm_ui$Element$px(author$project$Palette$spacing.normal))
		]),
	{description: 'okay', src: 'images/logo.png'});
...
var author$project$Main$viewSearchBar = A2(
		...
		]),
	{
		label: A2(
			...
			_List_Nil,
			mdgriffith$elm_ui$Element$text('')),
		onChange: author$project$Main$Search,
		placeholder: elm$core$Maybe$Just(
			A2(
				mdgriffith$elm_ui$Element$Input$placeholder,
				_List_Nil,
				mdgriffith$elm_ui$Element$text('ass'))),
		text: ''
	});
var author$project$Main$viewSignUpButton = A2(
	mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$size(18),
			mdgriffith$elm_ui$Element$Font$italic,
			author$project$Palette$retroShadow(author$project$Palette$color.body),
			mdgriffith$elm_ui$Element$Background$color(author$project$Palette$color.primary),
			mdgriffith$elm_ui$Element$Font$color(author$project$Palette$color.background),
			mdgriffith$elm_ui$Element$padding(5)
		]),
	{
...
var author$project$Main$viewNavbar = A2(
	...
	_List_fromArray(
		[
			...
			author$project$Main$viewNavbarLogo),
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[mdgriffith$elm_ui$Element$alignLeft, mdgriffith$elm_ui$Element$centerY]),
			mdgriffith$elm_ui$Element$text('TXTUARY')),
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			author$project$Main$viewLoginButton),
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[mdgriffith$elm_ui$Element$alignRight, mdgriffith$elm_ui$Element$centerY]),
			author$project$Main$viewSignUpButton)
		]));
var author$project$Palette$fontMono = mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$external(
			{name: 'Nanum Gothic Coding', url: 'https://fonts.googleapis.com/css?family=Nanum+Gothic+Coding'})
		]));
...
var author$project$Palette$mainWidth = mdgriffith$elm_ui$Element$width(
...
var author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$Background$color(
			A4(mdgriffith$elm_ui$Element$rgba, 0.99, 0.99, 1, 1)),
			mdgriffith$elm_ui$Element$Font$color(author$project$Palette$color.black),
			mdgriffith$elm_ui$Element$Font$size(24),
			author$project$Palette$fontMono
		]),
	A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Palette$mainWidth,
						mdgriffith$elm_ui$Element$centerX,
						mdgriffith$elm_ui$Element$spacing(author$project$Palette$spacing.small)
					]),
				_List_fromArray(
				...
				mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[author$project$Palette$mainWidth, mdgriffith$elm_ui$Element$centerX]),
				_List_fromArray(
					[author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem, author$project$Main$viewFeedItem]))
			])));
